...
2. In `R`, use the following `devtools` command to install the anydrugaspirin0615 package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/anydrugaspirin0615"
...
License
=======
The anydrugaspirin0615 package is licensed under Apache License 2.0

Development
===========
anydrugaspirin0615 was developed in ATLAS and R Studio.
