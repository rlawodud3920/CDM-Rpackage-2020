...
OhdsiRTools::checkUsagePackage("anydrugaspirin0615")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/anydrugaspirin0615.pdf")
shell("R CMD Rd2pdf ./ --output=extras/anydrugaspirin0615.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "anydrugaspirin0615")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("anydrugaspirin0615")
