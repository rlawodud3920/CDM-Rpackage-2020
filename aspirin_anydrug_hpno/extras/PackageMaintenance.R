...
OhdsiRTools::checkUsagePackage("aspirinanydrug")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/aspirinanydrug.pdf")
shell("R CMD Rd2pdf ./ --output=extras/aspirinanydrug.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("aspirinanydrug")
