...
2. In `R`, use the following `devtools` command to install the metformin0619 package:
...
License
=======
The metformin0619 package is licensed under Apache License 2.0

Development
===========
metformin0619 was developed in ATLAS and R Studio.
