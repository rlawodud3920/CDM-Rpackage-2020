...
OhdsiRTools::checkUsagePackage("metforminanydrug")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/metforminanydrug.pdf")
shell("R CMD Rd2pdf ./ --output=extras/metforminanydrug.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("metforminanydrug")
