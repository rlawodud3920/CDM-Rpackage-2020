...
2. In `R`, use the following `devtools` command to install the metforminanydrug package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/metforminanydrug"
...
License
=======
The metforminanydrug package is licensed under Apache License 2.0

Development
===========
metforminanydrug was developed in ATLAS and R Studio.
