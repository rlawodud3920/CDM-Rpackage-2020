...
2. In `R`, use the following `devtools` command to install the metforminDM package:
...
License
=======
The metforminDM package is licensed under Apache License 2.0

Development
===========
metforminDM was developed in ATLAS and R Studio.
