...
OhdsiRTools::checkUsagePackage("metforminDM")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/metforminDM.pdf")
shell("R CMD Rd2pdf ./ --output=extras/metforminDM.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("metforminDM")
