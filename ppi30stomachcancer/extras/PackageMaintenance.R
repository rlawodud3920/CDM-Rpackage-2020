...
OhdsiRTools::checkUsagePackage("ppi30stomachcancer")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ppi30stomachcancer.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ppi30stomachcancer.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ppi30stomachcancer")
