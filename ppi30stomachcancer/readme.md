...
2. In `R`, use the following `devtools` command to install the ppi30stomachcancer package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/ppi30stomachcancer"
...
License
=======
The ppi30stomachcancer package is licensed under Apache License 2.0

Development
===========
ppi30stomachcancer was developed in ATLAS and R Studio.
