...
{DEFAULT @vocabulary_database_schema = 'CMSDESynPUF100k'}
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1750500,21113674)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1750500,21113674)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1713332,19073187)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1713332,19073187)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19019852,40087792)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19019852,40087792)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19080187)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19080187)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1750500,21113674,1707164)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1750500,21113674,1707164)
  and c.invalid_reason is null
...
WHERE (C.days_supply >= 7 and C.days_supply <= 14)
...
FROM (
  ...
  INNER JOIN #qualified_events QE
  ON c.subject_id = QE.person_id
  WHERE DATEDIFF(DAY, cohort_start_date, QE.start_date) >= @window_start
  AND DATEDIFF(DAY, cohort_start_date, QE.start_date) <= @window_end
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (997276,953076,950696,19003317,961047)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (997276,953076,950696,19003317,961047)
  and c.invalid_reason is null
...
SELECT 0 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4319441,4318534,4265600)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4319441,4318534,4265600)
  and c.invalid_reason is null
