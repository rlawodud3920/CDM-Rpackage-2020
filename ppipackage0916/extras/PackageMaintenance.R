...
OhdsiRTools::checkUsagePackage("ppipackage0916")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ppipackage0916.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ppipackage0916.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ppipackage0916")
