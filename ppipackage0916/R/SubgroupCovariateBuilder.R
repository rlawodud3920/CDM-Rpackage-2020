...
createSubgroupCovariateSettings <- function(windowStart = -365, windowEnd = -1, analysisId = 998) {
  ...
  attr(covariateSettings, "fun") <- "ppipackage0916::getDbSubgroupCovariateData"
...
getDbSubgroupCovariateData <- function(connection,
  ...
  covariateRef <- data.frame(covariateId = c(1000,2000,3000) + covariateSettings$analysisId,
                             covariateName = c("HP eradication","H2RA","Gastric Ulcer"),
