...
2. In `R`, use the following `devtools` command to install the ppipackage0916 package:
...
License
=======
The ppipackage0916 package is licensed under Apache License 2.0

Development
===========
ppipackage0916 was developed in ATLAS and R Studio.
