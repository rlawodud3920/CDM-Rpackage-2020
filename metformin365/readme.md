...
2. In `R`, use the following `devtools` command to install the metformin365 package:
...
License
=======
The metformin365 package is licensed under Apache License 2.0

Development
===========
metformin365 was developed in ATLAS and R Studio.
