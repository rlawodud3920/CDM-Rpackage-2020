...
OhdsiRTools::checkUsagePackage("metformin365")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/metformin365.pdf")
shell("R CMD Rd2pdf ./ --output=extras/metformin365.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("metformin365")
