...
OhdsiRTools::checkUsagePackage("statin300609")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/statin300609.pdf")
shell("R CMD Rd2pdf ./ --output=extras/statin300609.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("statin300609")
