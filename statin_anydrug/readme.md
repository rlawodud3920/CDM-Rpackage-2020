...
2. In `R`, use the following `devtools` command to install the statin300609 package:
...
License
=======
The statin300609 package is licensed under Apache License 2.0

Development
===========
statin300609 was developed in ATLAS and R Studio.
