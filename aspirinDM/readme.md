...
2. In `R`, use the following `devtools` command to install the aspirinDM package:
...
License
=======
The aspirinDM package is licensed under Apache License 2.0

Development
===========
aspirinDM was developed in ATLAS and R Studio.
