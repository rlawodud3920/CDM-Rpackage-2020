...
OhdsiRTools::checkUsagePackage("aspirinDM")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/aspirinDM.pdf")
shell("R CMD Rd2pdf ./ --output=extras/aspirinDM.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("aspirinDM")
