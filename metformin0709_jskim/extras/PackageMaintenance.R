...
OhdsiRTools::checkUsagePackage("metformin0619")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/metformin0619.pdf")
shell("R CMD Rd2pdf ./ --output=extras/metformin0619.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("metformin0619")
