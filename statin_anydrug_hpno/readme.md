...
2. In `R`, use the following `devtools` command to install the statinanydrug package:
...
License
=======
The statinanydrug package is licensed under Apache License 2.0

Development
===========
statinanydrug was developed in ATLAS and R Studio.
