...
OhdsiRTools::checkUsagePackage("statinanydrug")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/statinanydrug.pdf")
shell("R CMD Rd2pdf ./ --output=extras/statinanydrug.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("statinanydrug")
