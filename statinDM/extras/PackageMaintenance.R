...
OhdsiRTools::checkUsagePackage("statinDM")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/statinDM.pdf")
shell("R CMD Rd2pdf ./ --output=extras/statinDM.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("statinDM")
