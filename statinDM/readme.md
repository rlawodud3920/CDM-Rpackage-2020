...
2. In `R`, use the following `devtools` command to install the statinDM package:
...
License
=======
The statinDM package is licensed under Apache License 2.0

Development
===========
statinDM was developed in ATLAS and R Studio.
