...
2. In `R`, use the following `devtools` command to install the aspirinanydrug package:
...
License
=======
The aspirinanydrug package is licensed under Apache License 2.0

Development
===========
aspirinanydrug was developed in ATLAS and R Studio.
