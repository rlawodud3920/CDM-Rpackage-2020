...
OhdsiRTools::checkUsagePackage("aspirin365")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/aspirin365.pdf")
shell("R CMD Rd2pdf ./ --output=extras/aspirin365.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("aspirin365")
