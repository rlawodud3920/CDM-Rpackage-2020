...
2. In `R`, use the following `devtools` command to install the aspirin365 package:
...
License
=======
The aspirin365 package is licensed under Apache License 2.0

Development
===========
aspirin365 was developed in ATLAS and R Studio.
